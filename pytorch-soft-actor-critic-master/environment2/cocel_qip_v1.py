import mujoco
import numpy as np
from environment2.cocel_qip.cocel_qip import QIPAsset
from environment2.cocel_qip.viewer import Viewer
from copy import deepcopy
from math import sin, cos

class CoCELQIPENV(QIPAsset):
    def __init__(self):
        super(CoCELQIPENV, self).__init__()
        self.state_dim = 14
        self.action_dim = 1
    ...
    def _get_reward(self, obs, act):
        ...
        notdone = notdone and np.all(np.abs(th_dot) < 45.)
    ...
    def _get_obs(self):
        ...
        ang_vel = (self.state[1:5] - self.prev_state[1:5]) / self.sample_time
        ang1 = self.state[1]
    ...
    def _viewer_setup(self):
        self.model = mujoco.MjModel.from_xml_path('./environment2/mujoco/cocel_qip.xml')
