import mujoco
import numpy as np
from environment.cocel_qip.cocel_qip import QIPAsset
from environment.cocel_qip.viewer import Viewer
...
class CoCELQIPENV(QIPAsset):
    ...
    def _viewer_setup(self):
        self.model = mujoco.MjModel.from_xml_path('./environment/mujoco/cocel_qip.xml')
